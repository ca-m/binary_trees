...
/**
 * is_left - checks if node is left child of some other node
...
/**
 * is_right - checks if node is right child of some other node
 * @node: pointer to node to be checked
 * Return: 1 if is right child, otherwise 0
 */
